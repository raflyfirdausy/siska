...
{{-- Judul halaman --}}
@section('page-title')
    <strong>Tambah</strong> Data Sumber Anggaran
@endsection

{{-- Isi dari halaman, konten utama dari suatu halaman --}}
@section('page-content')
  <form action="{{ action("Finance\BudgetSourceController@store") }}" method="POST" data-parsley-validate>
    @csrf
    <div class="row">
      <div class="col-md-6">
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12">
                <h4>Silahkan isi keterangan sumber anggaran disini</h4>
