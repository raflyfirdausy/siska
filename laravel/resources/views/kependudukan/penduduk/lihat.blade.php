...
{{-- Judul halaman --}}
@section('page-title')
    <strong>Lihat</strong> Penduduk : {{ $resident->name }}
@endsection
          ...
          <div class="col-md-12">
            ...
            <div class="form-horizontal">
              <div class="form-group">
                <div class="col-md-12">
                  <img width="500px" height="500px" src="{{ $resident->photo ? asset($resident->photo) : asset('img/avatars/avatar2_big@2x.png') }}" alt="" class="img-responsive">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12 form-label">NIK</label>
                <div class="col-md-12">
                  <input type="text" class="form-control" name="nik" value="{{ $resident->nik }}" disabled>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12 form-label">Nama Lengkap</label>
                <div class="col-md-12">
                  <input type="text" class="form-control" value="{{ $resident->name }}" disabled>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12 form-label">Hubungan Dengan Keluarga</label>
                <div class="col-md-12">
                  <input type="text" class="form-control" value="{{ $resident->family_member->relation }}" disabled>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->birth_place }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $resident->birthday->format('d/M/Y') }}" disabled>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->jenkel }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->goldar }}" disabled>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->kewarganegaraan }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->agama }}" disabled>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->marriage_status }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->resident_status }}" disabled>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->education->name }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" class="form-control" value="{{ $resident->occupation->name }}" disabled>
                    </div>
                  </div>
                </div>
                <div class="col-sm-9 col-sm-offset-3">
                  <div class="pull-right">
                    <a href="{{ url("penduduk") }}" class="btn btn-default">Kembali</a>
                    <a href="{{ url("penduduk/$resident->nik/ubah") }}" class="btn btn-success">Ubah</a>
                  </div>
                </div>
              </div>
            </div>
...
<div class="modal fade" id="modalBiodata" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-bio-penduduk">
      <div class="modal-body">
          <div class="form-group">
...
<div class="modal fade" id="modalketpengantar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-pengantar">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="modalketdomisili" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-domisili">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalskck" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-skck">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalsktm" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-sktm">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalkehilangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-kehilangan">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalkeramaian" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-izin-keramaian">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalusaha" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-usaha">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalketpddk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-penduduk">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalktpproses" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-ket-ktp-proses">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalsporadik" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form  method="GET" action="/penduduk/{{ $resident->nik }}/cetak-sporadik">
      <div class="modal-body">
          <div class="form-group">
...
<div class="modal fade" id="modaldupnikah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="{{ url("penduduk/$resident->nik/cetak-perdupnikah") }}">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalpermohonankk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="{{ url("penduduk/$resident->nik/cetak-perkk") }}">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalpermohonanpkk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="{{ url("penduduk/$resident->nik/cetak-perpkk") }}">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalakta" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form  method="GET" action="/penduduk/{{ $resident->nik }}/cetak-per-akta">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modalcerai" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form  method="GET" action="/penduduk/{{ $resident->nik }}/cetak-per-cerai">
      <div class="modal-body">
          <div class="form-group">
            <label class="form-label">Nomor Surat </label>
            <input type="number" name="no_surat" class="form-control">
...
<div class="modal fade" id="modaldupkelahiran" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-per-dup-kelahiran">
        <div class="modal-body">
            <div class="form-group">
              <label class="form-label">Nomor Surat </label>
...
<div class="modal fade" id="modalperakta" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="GET" action="/penduduk/{{ $resident->nik }}/cetak-pernyataan-akta">
          <div class="modal-body">
              <div class="form-group">
                <label class="form-label">Nomor Surat </label>
                <input type="text" name="no_surat" class="form-control">
