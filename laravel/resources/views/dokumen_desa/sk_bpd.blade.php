...
{{-- Judul halaman --}}
@section('page-title')
    <strong>Daftar</strong> Surat Keputusan BPD
@endsection
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="pull-right">
              ...
              <a href="{{ url("/download-surat-keputusan-bpd?") }}q={{$ket['q']}}&bulan={{$ket['bulan']}}&tahun={{$ket['tahun']}}" class="btn btn-danger"><i class="fa fa-download"></i> Export</a>                   
            </div>
          </div>
        </div>
...
<div class="modal fade" id="modal-tambah-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalTambahEdit">Tambah / Edit Agenda Surat Keputusan BPD</h4>
      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                    <label class="form-label">Nomor Putusan</label>
                    <input required type="text" id="nomor" name="nomor" class="form-control">
  ...
  <script>
    ...
    //   $("#NomerWarning").text("");
      $("#form_tambah_edit").attr("action", '{{ URL::to("/tambah-surat-keputusan-bpd") }}'); 
    });

    $('.editData').on('click', function() {
      $("#form_tambah_edit").attr("action", '{{ URL::to("/edit-surat-keputusan-bpd") }}');
      $("#NomerWarning").text("");
      let surat = $(this).data('surat');          
      $("#id_sk").attr("value", surat.id);      
      $('#nomor').val(surat.nomor);
    ...
    $('.hapusData').on('click', function() {
      ...
      $('#form-delete').attr('action', '{{ URL::to("/hapus-surat-keputusan-bpd") }}');
    });    
