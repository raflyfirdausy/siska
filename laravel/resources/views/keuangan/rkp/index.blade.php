...
{{-- Judul halaman --}}
@section('page-title')
  <strong>Rencana Kerja Pemerintah</strong>
@endsection
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="pull-right">
                    ...
                    <a href="{{ url("rkp/tambah?kategori=penyelenggaraan") }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
                  </div>
                </div>
              </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <div class="form-group">
                        <a href="{{ url("rkp/$p->id/ubah") }}" class="btn btn-warning" style="margin-bottom:0"> Ubah</a>
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="pull-right">
                    {{-- <a href="{{ url("kelahiran/import") }}" class="btn btn-info"><i class="fa fa-upload"></i> Import</a> --}}
                    <a href="{{ url("rkp/tambah?kategori=pelaksanaan") }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
                  </div>
                </div>
              </div>
              <table id="posts-table" class="table table-tools table-striped">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="pull-right">
                    {{-- <a href="{{ url("kelahiran/import") }}" class="btn btn-info"><i class="fa fa-upload"></i> Import</a> --}}
                    <a href="{{ url("rkp/tambah?kategori=pembinaan") }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
                  </div>
                </div>
              </div>
              <table id="posts-table" class="table table-tools table-striped">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="pull-right">
                    {{-- <a href="{{ url("kelahiran/import") }}" class="btn btn-info"><i class="fa fa-upload"></i> Import</a> --}}
                    <a href="{{ url("rkp/tambah?kategori=pemberdayaan") }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
                  </div>
                </div>
              </div>
              <table id="posts-table" class="table table-tools table-striped">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Apakah Anda yakin akan menghapus RKP dari RPJM <span id="nama">-</span>?
        </div>
