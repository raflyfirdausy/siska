...
{{-- Judul halaman --}}
@section('page-title')
    <strong>Daftar</strong> Peraturan Kepala Desa
@endsection
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="pull-right">
              ...
              <a href="{{ url("/download-perkades?") }}q={{$ket['q']}}&bulan={{$ket['bulan']}}&tahun={{$ket['tahun']}}" class="btn btn-danger"><i class="fa fa-download"></i> Export</a>                   
            </div>
          </div>
        </div>
...
<div class="modal fade" id="modal-tambah-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalTambahEdit">Tambah / Edit Agenda Peraturan Kepala Desa</h4>
      </div>
  ...
  <script>
    ...
    //   $("#NomerWarning").text("");
      $("#form_tambah_edit").attr("action", '{{ URL::to("/tambah-perkades") }}'); 
    });    

    $('.editData').on('click', function() {
      $("#form_tambah_edit").attr("action", '{{ URL::to("/edit-perkades") }}');
      $("#NomerWarning").text("");
    ...
    $('.hapusData').on('click', function() {
      ...
      $('#form-delete').attr('action', '{{ URL::to("/hapus-perkades") }}');
    });    
