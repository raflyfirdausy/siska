...
{{-- Judul halaman --}}
@section('page-title')
    <strong>Ubah</strong> Role {{ $role->name }}
@endsection

{{-- Isi dari halaman, konten utama dari suatu halaman --}}
@section('page-content')
<form action="{{ url("/role/$role->id/ubah") }}" method="POST" data-parsley-validate>
  @csrf
  <div class="row">
    <div class="col-md-6">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <p>Silahkan ubah data role {{ $role->name }} disini</p>
              <div class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                      <label>
                          <input type="checkbox" {{ in_array($p->id, $permissionsInRole) ? 'checked' : '' }} name="permission_ids[]" value="{{$p->id}}"> {{ $p->name }}
                      </label>
                  </div>
                  @endforeach
                </div>
